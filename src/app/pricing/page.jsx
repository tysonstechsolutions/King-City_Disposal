            ...
            {config.dumpsters.map((dumpster, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Overages */}
                  <div className="bg-neutral-50 rounded-lg p-4 mb-6 text-sm border border-neutral-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-neutral-900">Surcharge Items</h2>
              </div>
              ...
              <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden">
                {config.surchargeItems.map((item, index) => (
                  <div
                    key={index}
                    className={`flex justify-between items-center p-4 ${index !== config.surchargeItems.length - 1 ? 'border-b border-neutral-100' : ''}`}
                  >
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-neutral-900">Prohibited Items</h2>
              </div>
              <p className="text-neutral-600 mb-6">
