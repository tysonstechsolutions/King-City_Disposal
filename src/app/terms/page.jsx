    ...
    <div className="min-h-screen bg-dark-900 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-neutral prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">2. Rental Agreement</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">3. Prohibited Items</h2>
            <p className="text-dark-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">5. Rental Period</h2>
            <p className="text-dark-300">
          ...
          <section className="mb-8">
            ...
            <p className="text-dark-300">
              ...
              <a href={`tel:${config.phoneRaw}`} className="text-primary hover:underline">
                {config.phone}
              </a>
              .
            </p>
