...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: 'en_US',
      type: 'website',
      // OG image auto-generated by ./opengraph-image.jsx (per-service)
    },
    twitter: {
      ...
      <section className="bg-dark-800 border-y border-dark-700 py-10">
        <div className="container-custom grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-dark-300">From ${config.dumpsters[0].pricing['10-day']} with delivery + pickup</p>
          </div>
        </div>
      </section>
