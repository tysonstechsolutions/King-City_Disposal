...
export const metadata = {
  ...
  description: `${config.businessName} is a locally owned dumpster rental company serving ${config.address.city}, IL and ${config.serviceTowns.length}+ communities in Southern Illinois. ${config.fleet['20yd'] + config.fleet['30yd']} dumpsters in our fleet, same-day delivery, transparent pricing.`,
  alternates: {
    canonical: `${config.websiteUrl}/about`,
  },
  openGraph: {
    title: `Meet ${config.businessName} — Locally Owned in ${config.address.city}, IL`,
    description: `Family-owned dumpster rental serving Southern Illinois. ${config.fleet['20yd'] + config.fleet['30yd']} dumpsters, ${config.serviceTowns.length}+ towns served, same-day delivery available.`,
...
export default function AboutPage() {
  const fleetTotal = config.fleet['20yd'] + config.fleet['30yd']
  ...
  return (
    <>
      ...
      {/* Trust Stats — concrete E-E-A-T signals (numbers Google's algorithm
          treats as proof of an established operating business) */}
      <section className="bg-dark-950 border-y border-dark-800">
        <div className="container-custom py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl font-bold text-primary">{fleetTotal}</div>
              <div className="text-dark-300 text-sm">Dumpsters in fleet</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">{config.serviceTowns.length}+</div>
              <div className="text-dark-300 text-sm">Towns served</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">{config.serviceRadius}mi</div>
              <div className="text-dark-300 text-sm">Service radius</div>
            </div>
            <div>
              ...
              <div className="text-dark-300 text-sm">Customer rating</div>
            </div>
          </div>
        </div>
      </section>
