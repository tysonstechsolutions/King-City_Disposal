  ...
  return (
    <div className="min-h-screen bg-dark-800 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* Info Box */}
        <div className="bg-dark-900 rounded-xl p-6 mb-8 border border-dark-700 shadow-sm">
        ...
        <div className="bg-primary/10 border border-primary-200 rounded-xl p-4 mb-8">
          ...
          <p className="text-dark-300 text-sm mt-2">
            <code className="text-primary font-medium">STATUS</code> to check dates &bull;
            <code className="text-primary font-medium"> PICKUP</code> when you're ready
          </p>
        </div>
