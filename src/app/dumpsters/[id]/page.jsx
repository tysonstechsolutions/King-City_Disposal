          ...
          <div className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-white/10 rounded-xl p-4 text-center">
                ...
                <p className="text-neutral-400 text-sm">Weight Included</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4 text-center">
      ...
      <section className="section bg-neutral-50">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Left: Visual */}
            <div className="bg-white rounded-xl border border-neutral-200 p-8 lg:p-12">
              <div className="text-center mb-8">
                <Truck className="w-32 h-32 text-neutral-300 mx-auto mb-4" />
                <div className="inline-block bg-primary-600 text-white px-6 py-3 rounded-full font-bold text-xl">
              ...
              <div className="bg-neutral-50 rounded-xl p-6 border border-neutral-200">
                <h3 className="font-semibold text-neutral-900 mb-4 text-center">Dimensions</h3>
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold text-primary-600">{dumpster.dimensions.length}&apos;</p>
                    <p className="text-neutral-500 text-sm">Length</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-primary-600">{dumpster.dimensions.width}&apos;</p>
                    <p className="text-neutral-500 text-sm">Width</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-primary-600">{dumpster.dimensions.height}&apos;</p>
                    <p className="text-neutral-500 text-sm">Height</p>
                  </div>
                </div>
            ...
            <div>
              ...
              {/* Best For */}
              <div className="mb-8">
                <h3 className="text-neutral-900 font-semibold mb-4">Best For:</h3>
              ...
              <div className="bg-white rounded-xl p-6 border border-neutral-200 mb-6">
                <h3 className="font-semibold text-neutral-900 mb-4">Capacity</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Volume</span>
                    <span className="text-neutral-900 font-medium">{dumpster.capacity}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Equivalent to</span>
                    <span className="text-neutral-900 font-medium">{dumpster.wheelbarrowLoads}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Weight Included</span>
                    <span className="text-primary-600 font-medium">{dumpster.weightIncluded}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary-50 rounded-xl p-6 border border-primary-200">
                <div className="text-center mb-6">
                  ...
                  <p className="text-5xl font-bold text-primary-600">${dumpster.pricing['10-day']}</p>
                  <p className="text-sm text-neutral-500 mt-1">Includes delivery, pickup & {dumpster.weightIncluded}</p>
                </div>

                <div className="border-t border-primary-200 pt-4 space-y-2 text-sm mb-6">
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Extra weight over {dumpster.weightIncluded}</span>
                    <span className="text-neutral-900">${dumpster.weightOverage}/ton</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Extension (per week)</span>
                    <span className="text-neutral-900">${dumpster.extensionRate}</span>
                  </div>
                </div>

                <Link
                  href={`/book?size=${dumpster.id}`}
                  className="block w-full text-center bg-primary-600 hover:bg-primary-700 text-white font-semibold py-4 rounded-lg transition-colors"
                >
                  Book This Dumpster
                </Link>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {otherDumpsters.map((other) => (
                <Link
                  ...
                  className="bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 hover:border-primary-300 rounded-xl p-6 transition-all"
                >
                  <div className="flex items-center gap-3 mb-3">
                    <Truck className="w-8 h-8 text-neutral-400" />
                    <h3 className="text-xl font-bold text-neutral-900">{other.name}</h3>
                  </div>
                  <p className="text-neutral-600 text-sm mb-4">{other.description}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-primary-600 font-bold">${other.pricing['10-day']}</span>
                    <span className="text-neutral-500 text-sm">{other.capacity}</span>
                  </div>
                </Link>
              ))}
            </div>
