...
export default function ChatbotWidget() {
  ...
  const handleConfirm = async () => {
    ...
    setIsTyping(false)
    const dumpster = config.dumpsters.find(d => d.id === bookingData.size)
    const price = dumpster.pricing[bookingData.duration]
    
    await addBotMessage(`✅ Booking sent!\n\n${config.businessName} will text you at the number you provided to confirm your ${dumpster.name} delivery on ${bookingData.deliveryDate}.\n\nTotal: $${price}\n\nQuestions? Call ${config.phone}`)
